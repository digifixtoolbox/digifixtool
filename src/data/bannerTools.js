export const BANNER_TOOLS = [
  ...
  { slug: "background-remover",   name: "Background Remover",        iconClass: "wand",            iconPalette: "red",    category: "Image",     hook: "Need to remove an image background?" },
  ...
  { slug: "passport-photo-maker", name: "Passport Photo Maker",      iconClass: "id",              iconPalette: "orange", category: "Image",     hook: "Need a compliant passport photo?" },
  ...
  { slug: "image-to-text",        name: "Image to Text (OCR)",       iconClass: "scan",            iconPalette: "red",    category: "Image",     hook: "Need to extract text from a photo?" },
  ...
  // PDF tools
  { slug: "compress-pdf",         name: "PDF Compressor",            iconClass: "file-minus",      iconPalette: "red",    category: "PDF",       hook: "Need to shrink a PDF for email?" },
  { slug: "merge-pdfs",           name: "Merge PDFs",                iconClass: "files",           iconPalette: "red",    category: "PDF",       hook: "Need to merge multiple PDF files?" },
  { slug: "pdf-to-jpg",           name: "PDF to JPG",                iconClass: "file-export",     iconPalette: "red",    category: "PDF",       hook: "Need to convert a PDF to images?" },
  { slug: "images-to-pdf",        name: "Images to PDF",             iconClass: "file-import",     iconPalette: "red",    category: "PDF",       hook: "Need to combine photos into a PDF?" },
  // Text tools
  { slug: "word-count",           name: "Word Counter",              iconClass: "counter",         iconPalette: "green",  category: "Text",      hook: "Need to count words in your text?" },
  ...
  { slug: "text-diff",            name: "Text Difference Checker",   iconClass: "git-diff",        iconPalette: "orange", category: "Text",      hook: "Need to compare two texts?" },
  // Developer tools
  { slug: "json-formatter",       name: "JSON Formatter",            iconClass: "braces",          iconPalette: "orange", category: "Developer", hook: "Need to format or validate JSON?" },
  { slug: "base64",               name: "Base64 Encoder / Decoder",  iconClass: "lock",            iconPalette: "orange", category: "Developer", hook: "Need to encode or decode Base64?" },
  // Social tools
  ...
  { slug: "password-generator",   name: "Password Generator",        iconClass: "key",             iconPalette: "orange", category: "Utility",   hook: "Need a strong random password?" },
  // Special banners
  {
    slug: null,
    name: "Suggest a Tool",
