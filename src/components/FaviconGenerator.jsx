...
import { IconBrowser, IconShare } from '@tabler/icons-react';
...
export default function FaviconGenerator() {
  ...
  if (!imageUrl) return (
    <div style={cardStyle}>
      ...
      >
        <div style={{ fontSize: "48px", marginBottom: "16px" }}><IconBrowser size={48} color="#30A46C" stroke={2} /></div>
  ...
  return (
    <div style={cardStyle}>
      ...
      <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "16px", justifyContent: "center" }}>
        ...
        {supportsFileShare && <button onClick={handleShare} disabled={zipping} style={{ ...shareBtn, opacity: zipping ? 0.7 : 1, cursor: zipping ? "not-allowed" : "pointer" }}><IconShare size={16} stroke={2} /> Share</button>}
