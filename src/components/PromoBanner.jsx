...
export default function PromoBanner() {
  ...
  var b = banners[idx];
  return (
    <a href={b.href} style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "14px", background: b.bg, borderRadius: "14px", padding: "14px 20px", textDecoration: "none", width: "100%" }}>
      <span style={{ fontSize: "40px", lineHeight: "1", flexShrink: "0" }}>{b.icon}</span>
      <span style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
        <span style={{ fontSize: "15px", fontWeight: "600", color: "#1d1d1f", lineHeight: "1.2", display: "block" }}>{b.text}</span>
        <span style={{ fontSize: "14px", fontWeight: "700", color: b.color, lineHeight: "1.2", display: "block" }}>{b.cta}</span>
      </span>
    </a>
  );
}